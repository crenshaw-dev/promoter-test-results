# Setup Summary - 2025-10-14-13-44-40

## Configuration

### Test Parameters
- **Number of Assets:** 5
- **Timestamp:** 2025-10-14-13-44-40
...
- **Argo CD will deploy promoter manifests from:** ../promoter-test-results-external/runs/2025-10-14-13-44-40/manifests/promoter
...
- 1 Load Test Application (deploys from this repo's ../promoter-test-results-external/runs/2025-10-14-13-44-40/manifests/promoter)
- 5 Asset AppProjects
...
Generated manifests are located in: `../promoter-test-results-external/runs/2025-10-14-13-44-40/manifests/`

All resources for each cluster are combined into a single file for easy application:

### Promoter Cluster
- `../promoter-test-results-external/runs/2025-10-14-13-44-40/manifests/promoter/all-resources.yaml` - Contains ClusterScmProvider, Namespaces, GitRepository, PromotionStrategy, and ArgoCDCommitStatus resources
- **Note:** GitHub App Secret (`promoter-github-app`) is created imperatively, not in manifests

### Argo CD Cluster
- `../promoter-test-results-external/runs/2025-10-14-13-44-40/manifests/argocd/all-resources.yaml` - Contains Load Test AppProject/Application, Asset AppProjects, repository write credential Secrets, and Asset Applications

### Destination Cluster
- `../promoter-test-results-external/runs/2025-10-14-13-44-40/manifests/destination/all-resources.yaml` - Contains all destination Namespaces
